...
pusher = Pusher(app_id=u'1246768', key=u'75f03824e1640a271d6f', secret=u'bda9cb2c7b339d3483dc', cluster=u'us2')
...
def getAnalyticsData():
    ...
    userIP = "72.138.138.18" if request.remote_addr == '127.0.0.1' else request.remote_addr
